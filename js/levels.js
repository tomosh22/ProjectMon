...
town0.points = [[13,3, 0,5,7], [1,7,2]]
town0.spawnPoint = [3,15]
town0.background = 0
...
town1.points = [[19,5, 1,7,2], [15,10,3],[0,5,5,13,7],[15,1,4],[15,2,4]]
town1.spawnPoint = [5,18]
town1.background = 0
	
	
town2 = new level()
town2.tiles = [[[162,17], [163,17], [174,17], [185,17], [192,17],[193,17], 17,17,17,17,17,17,16],
...
town2.points = [[17,5,5,4,4],[14,2,3],[5,10,4]]
...
hospital.points = [[7,3,"outside",10,16],[7,4,"outside",10,16]]
...
shop.points = [[7,2,"outside",2,16],[7,3,"outside",2,16]]
shop.spawnPoint = [3,6]
shop.background = 55
