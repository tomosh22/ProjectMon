...
$(document).ready(function() {
	...
	currentMonsters = [{name:"Bulbasaur", hp:30, maxhp:30, type:"grass", attacks:{
						1:{name:"Vine Whip", type:"grass", damage:5, accuracy:100, effect:null},
						2:{name:"Slam", type:"normal", damage:5, accuracy:100, effect:null},
						3:{name:"Leaf Blade", type:"grass", damage:10, accuracy:50, effect:null},
						4:{name:"Confusion", type:"psychic", damage:8, accuracy:80, effect:null}},
	...
	npcs = [{map:maps[2],x:5,y:4,ready:true, team:[{name:"Bulbasaur", hp:30, maxhp:30, type:"grass", attacks:{
						1:{name:"Vine Whip", type:"grass", damage:5, accuracy:100, effect:null},
						2:{name:"Slam", type:"normal", damage:5, accuracy:100, effect:null},
						3:{name:"Leaf Blade", type:"grass", damage:10, accuracy:50, effect:null},
						4:{name:"Confusion", type:"psychic", damage:8, accuracy:80, effect:null}},
    ...
    function render() {
		...
		for (i=0;i<=npcs.length - 1;i++){
			if (npcs[i]["map"] == currentLevel){
				...
				context.fillRect((npcs[i]["y"])*16 + 7,(npcs[i]["x"]-2)*16 + 7,1,1)
